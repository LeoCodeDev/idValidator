...
const countryDocumentMap = {
  CL: {
    name: "Chile",
    document: ["national-id", "foreign-id", "driver-license", "passport"],
  },
  CO: {
    name: "Colombia",
    document: [
  ...
  CR: {
    name: "Costa Rica",
    document: ["national-id", "foreign-id", "passport"],
  },
...
const ValidationForm = ({ onValidation, handlePreviousStep }) => {
  const { country, documentType, setCountry, setDocumentType, setBothSides } =
    useValidationStore();
    ...
    <div>
      ...
      <div className="flex justify-between mt-6">
        ...
        <button
          ...
          className={`p-2 text-white rounded w-[45%] ${
            isButtonDisabled
